 ...
 */
public class ListAdapterTwo extends RecyclerView.Adapter {
    ...
    ListAdapterTwo(MainActivity activity, List<String> urls, List<String> captions){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder rHolder, int position) {
       ...
       final RecyclerView.ViewHolder r = rHolder;
        ...
        System.out.println("url at position " + position + " " + urls.get(position));


        System.out.println("trying clause");
        ...
        System.out.println("through try catch");
